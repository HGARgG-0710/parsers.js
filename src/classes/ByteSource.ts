...
import { InvalidFileReadPositionError } from "./Error.js"
...
*/
class BufferReader {
	private readonly readPos = new BytePos(true)
	private readonly tempData = Buffer.alloc(Chunk.size)
	...
	private isEndPos(bytePos: BytePos) {
	...
	constructor(
		...
		private readonly nextPos: BytePos,
		private readonly endPos: BytePos
	) {}
}
...
class ByteProvider {
	...
	private readonly pos = new BytePos()
