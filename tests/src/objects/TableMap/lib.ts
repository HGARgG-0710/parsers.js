...
const swap = new MethodTest("swap", function <
	...
	V = any,
	Default = any
>(this: TableMap<K, V, Default>, i: number, j: number) {
...
const set = new MethodTest("set", function <
	...
	V = any,
	Default = any
>(this: TableMap<K, V, Default>, key: K, value: V) {
...
const by = new MethodTest("by", function <
	K = any,
	V = any,
	Default = any
>(this: TableMap<K, V, Default>, key: K, value: V) {
...
const add = new MethodTest("add", function <
	K = any,
	V = any,
	Default = any
>(this: TableMap<K, V, Default>, index: number, pairs: array.Pairs<K, V>) {
	const sameAs = [...this]
