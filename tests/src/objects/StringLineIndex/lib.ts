...
const valueOf = new MethodTest(
	"valueOf",
	function (this: StringLineIndex, expected: number) {
...
const copy = new MethodTest(
	"copy",
	function (this: StringLineIndex, firstExcess: ILineIndex) {
...
const nextLineTip = new MethodTest(
	"nextLineTip",
	function (this: StringLineIndex, firstExcess: ILineIndex) {
		fromInvalid.withInstance(this, firstExcess)
...
const fromInvalid = new MethodTest(
	"fromInvalid",
	function (this: StringLineIndex, lineIndex: ILineIndex) {
...
const nextCharEdge = new MethodTest(
	"nextCharEdge",
	function (this: StringLineIndex, lengths: LineLengths) {
