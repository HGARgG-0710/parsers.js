...
const iterator = new MethodTest("Symbol.iterator", function <
	T = any
>(this: ArrayCollection<T>, sameAs: Iterable<T>) {
	baseIteratorCheck(this, sameAs)
})

const init = new MethodTest("init", function <
	T = any
>(this: ArrayCollection<T>, withArr: T[]) {
...
const write = new MethodTest("write", function <
	T = any
>(this: ArrayCollection<T>, i: number, value: T) {
	this.write(i, value)
...
const push = new MethodTest("push", function <
	T = any
>(this: ArrayCollection<T>, items: T[]) {
...
const copy = new MethodTest("copy", function <
	T = any
>(this: ArrayCollection<T>, newItem: T) {
