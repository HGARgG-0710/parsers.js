...
const read = new MethodTest("read", function <
	K = any,
	V = any
>(this: IPlainMap<K, V>, key: K, expected: V | undefined) {
	baseReadCheck(this, key, expected)
})

const write = new MethodTest("write", function <
	K = any,
	V = any
>(this: IPlainMap<K, V>, key: K, value: V) {
	this.write(key, value)
	baseReadCheck(this, key, value)
})

const annul = new MethodTest("annul", function <
	K = any,
	V = any
>(this: IPlainMap<K, V>, key: K) {
	this.annul(key)
...
const values = new MethodTest("values", function <
	K = any,
	V = any
>(this: IPlainMap<K, V>, sameAs: Iterable<V | undefined>) {
...
const copy = new MethodTest("copy", function <
	K = any,
	V = any
>(this: IPlainMap<K, V>, keys: Iterable<K>) {
	const copied = this.copy()
	for (const key of keys)
		assert.strictEqual(this.read(key), copied.read(key))
